import { Alert, Button, Card, CardSection, Center, Grid, Group, Image, Loader, Skeleton, Text } from "@mantine/core";
    ...
    if (imageUrl) {
      ...
      fetch('/api/resize', {
        ...
        .then(response => {
          ...
          console.log(`Preview image loaded with size ${dataURIBase64.length} bytes.`)
        })
        .catch(error => {
        ...
        <Grid>
          ...
          <Grid.Col span={4}>
            <Card shadow="sm" padding="lg" radius="md" withBorder>
              ...
              <Group justify="space-between" mt="md" mb="xs">
                <Text fw={500}>Full image using blur as placeholder. 
                Final full load may be longer than raw due to Next.js 
                render order.</Text>
              </Group>
            </Card>
          </Grid.Col>
          ...
          <Grid.Col span={4}>
            <Card shadow="sm" padding="lg" radius="md" withBorder>
              ...
              <Group justify="space-between" mt="md" mb="xs">
                ...
                <Button onClick={() => setShowFullImage(!showFullImage)} color="blue">
